...
public class StatementUpdateExtendedCommand implements Command {
    ...
    public Object execute(Object target, ConnectionContext ctx) throws SQLException {
        ...
        if(_columnIndexes != null) {
            return ((Statement) target).executeUpdate(sql, _columnIndexes);
        }
        else if(_columnNames != null) {
            return ((Statement) target).executeUpdate(sql, _columnNames);
        }
        else {
            return ((Statement) target).executeUpdate(sql, _autoGeneratedKeys);
        }
    }
