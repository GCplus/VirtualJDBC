...
public class StatementExecuteExtendedCommand implements Command {
    ...
    public Object execute(Object target, ConnectionContext ctx) throws SQLException {
        ...
        if(_columnIndexes != null) {
            return ((Statement) target).execute(sql, _columnIndexes);
        }
        else if(_columnNames != null) {
            return ((Statement) target).execute(sql, _columnNames);
        }
        else {
            return ((Statement) target).execute(sql, _autoGeneratedKeys);
        }
    }
