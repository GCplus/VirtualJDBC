...
public class VirtualSavepoint extends VirtualBase implements Savepoint {
    ...
    public int getSavepointId() throws SQLException {
        return sink.processWithIntResult(objectUid, CommandPool.getReflectiveCommand(JdbcInterfaceType.SAVEPOINT,"getSavepointId"));
    }

    public String getSavepointName() throws SQLException {
        return (String)sink.process(objectUid, CommandPool.getReflectiveCommand(JdbcInterfaceType.SAVEPOINT,"getSavepointName"));
    }
}
